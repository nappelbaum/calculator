...
<template>
  <div v-for="(credit, i) in offer" :key="credit.id" class="credit">
    <div
      v-show="show || !i"
      class="shadow-sm bg-white rounded-2 border-bottom border-1"
      :class="{ 'shadow-lg': show }"
    >
      <div class="p-4 d-flex">
        <div class="credit__col1">
          <div class="d-flex gap-3 align-items-start">
            <div class=""><img :src="credit.bankLogo" width="48px" height="48px" alt="logo" /></div>
            <div>
              <h6 class="m-0">
                <b>{{ credit.bankName }}</b>
              </h6>
